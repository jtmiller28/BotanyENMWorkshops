---
title: "05 Ecological Niche Modeling"
...
#### Load VIF-selected Climatic Layers
...
We want to select the model that has the smallest AICc score, has the lowest omission (model that drops the least number of species occurrence points in constructed niche), and maximum AUC (Area Under Curve).
```{r}
opt.seq <- results %>%
